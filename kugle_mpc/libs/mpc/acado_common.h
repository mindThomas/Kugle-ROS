...
/** Matrix of size: 51 x 23 (row major format)
 * 
...
/** Matrix of size: 500 x 8 (row major format) */
real_t evHx[ 4000 ];
...
/** Matrix of size: 10200 x 3 (row major format) */
real_t E[ 30600 ];
...
/** Matrix of size: 500 x 150 (row major format) */
real_t A[ 75000 ];
