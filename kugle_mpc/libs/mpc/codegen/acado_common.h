...
/** Matrix of size: 31 x 41 (row major format)
 * 
...
/** Matrix of size: 480 x 10 (row major format) */
real_t evHx[ 4800 ];

/** Matrix of size: 480 x 5 (row major format) */
real_t evHu[ 2400 ];
...
/** Matrix of size: 4650 x 5 (row major format) */
real_t E[ 23250 ];
...
/** Matrix of size: 484 x 150 (row major format) */
real_t A[ 72600 ];
